...
다음 로드맵은 [Spring Security의 인증·인가와 필터 체인](../11_09_07_Spring_Security_Fundamentals/09_07_Spring_Security_Fundamentals.md)이다. 웹 테스트에서 마주친 401·403을 출발점으로 “요청이 Controller에 오기 전에 무엇이 검사되는가”를 배우면, 정상 요청뿐 아니라 거부되어야 하는 요청도 테스트할 수 있다.
