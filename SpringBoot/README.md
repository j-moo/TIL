...
현재는 JPA `@Version`으로 오래된 수정과 저장 순간의 경쟁을 감지하고, rollback·409/412 응답과 재시도 판단을 정리했다. 다음에는 비관적 잠금과 조건부 UPDATE로 재고 차감처럼 충돌이 잦은 작업을 다룬다.
...
| 23 | 비관적 잠금·조건부 UPDATE와 재고 차감 | 충돌이 잦은 작업의 대기·원자적 갱신·재시도 선택 기준 이해 | 예정 |
