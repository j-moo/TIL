...
다음 확장 주제는 [Batch Fetching과 연관 조회 전략 비교](../19_09_16_Batch_Fetching/09_16_Batch_Fetching.md)다. 이번에 끈 묶음 조회를 활성화했을 때 무엇이 달라지는지, fetch join·DTO 조회와 어떻게 선택할지 이어서 학습한다.
