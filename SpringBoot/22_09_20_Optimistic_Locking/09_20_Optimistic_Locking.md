...
다음 확장 주제는 [비관적 잠금·조건부 UPDATE와 재고 차감](../23_09_21_Pessimistic_Locking_and_Atomic_Update/09_21_Pessimistic_Locking_and_Atomic_Update.md)이다. 충돌이 잦거나 한정 수량처럼 업무 조건을 한 번에 검사해야 할 때 대기, 원자적 갱신, 재시도 정책을 어떻게 선택하는지 비교한다.
