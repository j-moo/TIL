...
> 2026-09-10 기준 · 18개 학습 분야 · 학습 노트 205개 · Spring Boot 입문 노트 15개
>
> 개발 경험과 프로젝트 소개는 [GitHub 프로필](https://github.com/j-moo)에서 확인할 수 있습니다.

## Start Here

- **최신 강의노트**: [HTTP Interface 클라이언트](./SpringBoot/14_09_10_HTTP_Interface_Clients/09_10_HTTP_Interface_Clients.md) — 상세한 줄별 주석과 17회 실행을 예상하는 테스트로 선언·프록시·요청 매핑과 오류 처리의 책임을 설명합니다.
- **현재 학습 중**: [Spring Boot 로드맵](./SpringBoot/README.md) — RestClient에 이어 HTTP Interface 클라이언트를 정리했고, 다음은 페이지네이션·정렬과 조회 API입니다.
...
| 주제 | 핵심 내용 | 노트 |
| --- | --- | --- |
| Spring Boot 입문 시리즈 | IoC·DI, MVC·REST, JDBC·JPA, 트랜잭션·테스트·보안·운영, RestClient·HTTP Interface | [로드맵](./SpringBoot/README.md) |
...
2026년 7월 3일을 기준점으로, 9월 10일까지 **93개의 노트**를 추가했습니다. 아래는 이 기간의 학습 흐름이며 프로필 갱신 날짜와는 별도로 관리합니다.
...
| [Spring Boot](./SpringBoot) | IoC·DI, MVC·REST, JDBC·JPA·트랜잭션·테스트·보안·운영, 외부 HTTP API·HTTP Interface | 15 |
| [Git](./Git) | 버전 관리, 원격 저장소와 GitHub Actions CI | 3 |
| [Markdown](./markdown) | Markdown 문법과 문서 작성 연습 | 2 |

현재 총 **205개의 학습 노트**를 관리하고 있습니다. README·작성 프롬프트·점검 보고서는 학습 노트 수에서 제외합니다.
...
2. **다음 학습 — 페이지네이션·정렬과 조회 API**: 페이지 번호·크기·정렬의 검증을 DB 조회와 응답 DTO까지 연결합니다.
