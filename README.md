...
> 2026-09-20 기준 · 18개 학습 분야 · 학습 노트 213개 · Spring Boot 입문 노트 23개
>
> 개발 경험과 프로젝트 소개는 [GitHub 프로필](https://github.com/j-moo)에서 확인할 수 있습니다.

## Start Here

- **최신 강의노트**: [낙관적 잠금과 동시 수정 충돌](./SpringBoot/22_09_20_Optimistic_Locking/09_20_Optimistic_Locking.md) — `@Version`의 조건부 UPDATE 원리, 409·412 충돌 응답과 오래된 사본 테스트를 상세 주석으로 설명합니다.
- **현재 학습 중**: [Spring Boot 로드맵](./SpringBoot/README.md) — 낙관적 충돌 감지를 정리했고, 다음은 비관적 잠금·조건부 UPDATE와 재고 차감입니다.
...
2026년 7월 3일을 기준점으로, 9월 20일까지 **101개의 노트**를 추가했습니다. 아래는 이 기간의 학습 흐름이며 프로필 갱신 날짜와는 별도로 관리합니다.
...
| [Spring Boot](./SpringBoot) | IoC·DI, MVC·REST, JDBC·JPA·트랜잭션·테스트·보안·운영, 외부 HTTP 연동·조회 최적화·마이그레이션·동시성 제어 | 23 |
| [Git](./Git) | 버전 관리, 원격 저장소와 GitHub Actions CI | 3 |
| [Markdown](./markdown) | Markdown 문법과 문서 작성 연습 | 2 |

현재 총 **213개의 학습 노트**를 관리하고 있습니다. README·작성 프롬프트·점검 보고서는 학습 노트 수에서 제외합니다.
...
2. **다음 학습 — 비관적 잠금·조건부 UPDATE와 재고 차감**: 충돌 빈도가 높은 작업에서 대기, 원자적 갱신과 재시도 정책을 비교합니다.
