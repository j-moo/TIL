...
> 2026-09-09 기준 · 18개 학습 분야 · 학습 노트 204개 · Spring Boot 입문 노트 14개
>
> 개발 경험과 프로젝트 소개는 [GitHub 프로필](https://github.com/j-moo)에서 확인할 수 있습니다.

## Start Here

- **최신 강의노트**: [외부 HTTP API와 RestClient](./SpringBoot/13_09_09_External_HTTP_API_and_RestClient/09_09_External_HTTP_API_and_RestClient.md) — 상세한 줄별 주석과 14회 실행을 예상하는 테스트로 timeout·오류 분류·응답 검증·재시도 판단을 설명합니다.
- **현재 학습 중**: [Spring Boot 로드맵](./SpringBoot/README.md) — 운영 기초에 이어 외부 HTTP 호출의 실패 경계를 정리했고, 다음은 HTTP Interface 클라이언트의 선언과 프록시입니다.
...
| 주제 | 핵심 내용 | 노트 |
| --- | --- | --- |
| Spring Boot 입문 시리즈 | IoC·DI, MVC·REST, JDBC·JPA, 트랜잭션·테스트·보안·운영, 외부 HTTP API·RestClient | [로드맵](./SpringBoot/README.md) |
...
2026년 7월 3일을 기준점으로, 9월 9일까지 **92개의 노트**를 추가했습니다. 아래는 이 기간의 학습 흐름이며 프로필 갱신 날짜와는 별도로 관리합니다.
...
| [Spring Boot](./SpringBoot) | IoC·DI, MVC·REST, JDBC·JPA·트랜잭션·테스트·보안·운영, 외부 HTTP API | 14 |
| [Git](./Git) | 버전 관리, 원격 저장소와 GitHub Actions CI | 3 |
| [Markdown](./markdown) | Markdown 문법과 문서 작성 연습 | 2 |

현재 총 **204개의 학습 노트**를 관리하고 있습니다. README·작성 프롬프트·점검 보고서는 학습 노트 수에서 제외합니다.
...
2. **다음 학습 — HTTP Interface 클라이언트**: 인터페이스 선언과 프록시가 요청 구성의 어떤 부분을 대신하는지 RestClient와 비교합니다.
