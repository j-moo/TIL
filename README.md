...
> 2026-09-26 기준 · 18개 학습 분야 · 학습 노트 217개 · Spring Boot 입문 노트 27개
>
> 개발 경험과 프로젝트 소개는 [GitHub 프로필](https://github.com/j-moo)에서 확인할 수 있습니다.

## Start Here

- **최신 강의노트**: [Saga와 보상 트랜잭션](./SpringBoot/26_09_26_Saga_and_Compensating_Transactions/09_26_Saga_and_Compensating_Transactions.md) — 주문·재고·결제의 단계별 local transaction, 재시도·보상·멱등성·상태 복구를 자세한 주석과 함께 설명합니다.
- **현재 학습 중**: [Spring Boot 로드맵](./SpringBoot/README.md) — 여러 서비스의 장기 업무 흐름을 정리했고, 다음은 timeout·재시도·circuit breaker입니다.
...
2026년 7월 3일을 기준점으로, 9월 26일까지 **105개의 노트**를 추가했습니다. 아래는 이 기간의 학습 흐름이며 프로필 갱신 날짜와는 별도로 관리합니다.
...
| [Spring Boot](./SpringBoot) | IoC·DI, MVC·REST, JDBC·JPA·트랜잭션·테스트·보안·운영, 외부 HTTP·조회·마이그레이션·동시성·메시지·Saga | 27 |
| [Git](./Git) | 버전 관리, 원격 저장소와 GitHub Actions CI | 3 |
| [Markdown](./markdown) | Markdown 문법과 문서 작성 연습 | 2 |

현재 총 **217개의 학습 노트**를 관리하고 있습니다. README·작성 프롬프트·점검 보고서는 학습 노트 수에서 제외합니다.
...
2. **다음 학습 — timeout·재시도·circuit breaker**: 느린 외부 의존성에서 대기 시간·재호출 budget·격리와 복구 기준을 설계합니다.
